  ...
  return (
    <div className="Onboarding">
      ...
      <div className="onboarding-text-container">
        <h3>
          <span className="step-bold">Step 1:&nbsp;</span> Enter your name:
        </h3>
        {!displayInputBox ? (
          <div>
      ...
      <div className="onboarding-text-container">
        <h3>
          <span className="step-bold">Step 2: &nbsp;</span> Choose your
          character:
        </h3>
        <button
      ...
      <div className="onboarding-text-container">
        <h3>
          <span className="step-bold">Step 3:&nbsp; </span> Print your marker:
        </h3>
        <p>
          To explore space in 3D you will need a marker <br />
          Click on the rocket icon to print one out
        </p>
        <a href={CustomMarkerPDF} target="__blank">
          <img className="ar_marker_img" src={CustomARMarker} alt="ar marker" />
        </a>
        <p>
          Alternatively, you can display this marker on another device such as a
          spare phone
        </p>
        <p>
          {!nickname ? (
            <button
              ...
              onClick={() => {
                alert(
                  "Please enter your name before heading to mission control"
                );
              }}
            >
              To Mission Control&nbsp;&nbsp;
